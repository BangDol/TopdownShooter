...
void ATopdownShooterCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ATopdownShooterCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ATopdownShooterCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ATopdownShooterCharacter::OnResetVR);
}


void ATopdownShooterCharacter::OnResetVR()
{
	// If TopdownShooter is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in TopdownShooter.Build.cs is not automatically propagated
...
void ATopdownShooterCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ATopdownShooterCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
